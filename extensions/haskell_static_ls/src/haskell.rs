...
impl zed::Extension for HaskellExtension {
    ...
    fn language_server_command(
        ...
        let path = worktree
            .which("/Users/brian/Documents/static-ls/dist-newstyle/build/aarch64-osx/ghc-9.4.8/static-ls-0.1.2/x/static-ls/build/static-ls/static-ls")
            .ok_or_else(|| "could not find static-ls".to_string())?;
